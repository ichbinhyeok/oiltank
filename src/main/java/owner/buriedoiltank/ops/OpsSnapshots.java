...
public final class OpsSnapshots {
    ...
    public record AdminMetricsSnapshot(
            ...
            long serviceCtaViews,
            long serviceCtaClicks,
            long researchFormStarts,
            long successfulSubmissions,
            long documentInterpretationRequests,
            long qualifiedCases,
            long openCases,
            Map<String, Long> casesByStatus,
            Map<String, Long> submissionsByPage,
            Map<String, Long> submissionsByState,
            Map<String, Long> submissionsByQuestion,
